...
fn get_jump_effective_children(dialog: &Dialog, target_node: &DialogNode, _jump_target_point: Option<i32>) -> Vec<String> {
...
fn resolve_passthrough_children(dialog: &Dialog, children: &[String]) -> Vec<String> {
...
fn resolve_single_passthrough(dialog: &Dialog, uuid: &str) -> Vec<String> {
...
fn build_alias_logicalname_map(dialog: &Dialog) -> std::collections::HashMap<String, String> {
...
fn build_ancestor_sibling_map(dialog: &Dialog) -> std::collections::HashMap<String, HashSet<String>> {
...
fn build_node_tree(
    ...
    alias_logicalnames: &std::collections::HashMap<String, String>,
    sibling_map: &std::collections::HashMap<String, HashSet<String>>,
    ...
    let has_inherited_logicalname = alias_logicalnames.contains_key(uuid);
    if !has_inherited_logicalname && !node.children.is_empty() {
