        ...
        v_stack((
            ...
            h_stack((
                ...
                text_input(individual_dye_name)
                    ...
                    .style(|s| input_style(s).class(PlaceholderTextClass, |s| s.color(Color::rgb8(120, 120, 120)))),
            ))
            ...
            h_stack((
                {
                    ...
                    label(|| "Generate Dye")
                        ...
                        .on_click_stop(move |_| {
                            ...
                            if name.is_empty() {
                                status.set("Error: Dye name must contain alphanumeric characters".to_string());
                                return;
                            }
