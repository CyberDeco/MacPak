...
/// Get information about a GR2 file.
pub fn inspect_gr2(source: impl AsRef<Path>) -> Result<Gr2Info> {
    use MacLarian::formats::gr2::{Gr2File, Compression, PointerSize};
...
/// Mesh data extracted from a GR2 file for JSON export.
...
/// Skeleton data extracted from a GR2 file for JSON export.
#[derive(Debug, Clone, serde::Serialize)]
...
/// Complete GR2 model info for JSON export.
#[derive(Debug, Clone, serde::Serialize)]
...
/// Extract mesh and skeleton information from a GR2 file to JSON.
pub fn extract_gr2_info(source: impl AsRef<Path>) -> Result<Gr2ModelInfo> {
    use MacLarian::converter::gr2_to_gltf::Gr2Reader;
    ...
    Ok(Gr2ModelInfo {
        ...
        version: 7, // We'd need to expose this from the reader
