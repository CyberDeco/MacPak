...
use crate::state::DyeColorEntry;
use super::helpers::{copy_to_clipboard, normalize_hex, parse_hex_color, parse_hex_to_color, pick_color_from_screen};
...
pub fn color_row(entry: DyeColorEntry, status: RwSignal<String>) -> impl IntoView {
    ...
    h_stack((
        ...
        h_stack((
            ...
            // Hash symbol
            label(|| "#")
                .style(|s| s.font_size(10.0).font_family("monospace".to_string()).margin_left(4.0)),
